...
public class HxVolumetricCamera : MonoBehaviour
{
   ...
   // bool warned = false;
	...
	public static List<System.Action> OnPreCullActions = new List<System.Action>(); //%%%
	...
	void OnPreCull()
    {
		...
		var onPreCullArray = OnPreCullActions.ToArray();

		for (int i = 0; i < onPreCullArray.Length; i++)    //%%%
			onPreCullArray[i]();  //%%%
	}
